...
################################################################
# This is a generated script based on design: jpeg_encoder
#
...
# source jpeg_encoder_script.tcl
...
user.org:user:jpeg_encoder:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: jpeg_encoder_1, and set properties
  set jpeg_encoder_1 [ create_bd_cell -type ip -vlnv user.org:user:jpeg_encoder:1.0 jpeg_encoder_1 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net jpeg_encoder_1_M_AXIS_BIN [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins jpeg_encoder_1/M_AXIS_BIN]
connect_bd_intf_net -intf_net [get_bd_intf_nets jpeg_encoder_1_M_AXIS_BIN] [get_bd_intf_pins jpeg_encoder_1/M_AXIS_BIN] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets jpeg_encoder_1_M_AXIS_BIN]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets ps8_0_axi_periph_M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins v_frmbuf_rd_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net v_frmbuf_rd_0_m_axi_mm_video [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins v_frmbuf_rd_0/m_axi_mm_video]
  connect_bd_intf_net -intf_net v_frmbuf_rd_0_m_axis_video [get_bd_intf_pins jpeg_encoder_1/S_AXIS_IMAGE] [get_bd_intf_pins v_frmbuf_rd_0/m_axis_video]
connect_bd_intf_net -intf_net [get_bd_intf_nets v_frmbuf_rd_0_m_axis_video] [get_bd_intf_pins jpeg_encoder_1/S_AXIS_IMAGE] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets v_frmbuf_rd_0_m_axis_video]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net AXI_fifo_almost_empty [get_bd_pins jpeg_encoder_1/AXI_fifo_almost_empty] [get_bd_pins system_ila_0/probe11]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets AXI_fifo_almost_empty]
  connect_bd_net -net AXI_fifo_almost_full [get_bd_pins jpeg_encoder_1/AXI_fifo_almost_full] [get_bd_pins system_ila_0/probe9]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets AXI_fifo_almost_full]
  connect_bd_net -net AXI_fifo_empty [get_bd_pins jpeg_encoder_1/AXI_fifo_empty] [get_bd_pins system_ila_0/probe10]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets AXI_fifo_empty]
  connect_bd_net -net AXI_fifo_full [get_bd_pins jpeg_encoder_1/AXI_fifo_full] [get_bd_pins system_ila_0/probe8]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets AXI_fifo_full]
  connect_bd_net -net mcu_fifo_almost_empty [get_bd_pins jpeg_encoder_1/mcu_fifo_almost_empty] [get_bd_pins system_ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mcu_fifo_almost_empty]
  connect_bd_net -net mcu_fifo_almost_full [get_bd_pins jpeg_encoder_1/mcu_fifo_almost_full] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mcu_fifo_almost_full]
  connect_bd_net -net mcu_fifo_empty [get_bd_pins jpeg_encoder_1/mcu_fifo_empty] [get_bd_pins system_ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mcu_fifo_empty]
  connect_bd_net -net mcu_fifo_full [get_bd_pins jpeg_encoder_1/mcu_fifo_full] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mcu_fifo_full]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins jpeg_encoder_1/m_axis_bin_aresetn] [get_bd_pins jpeg_encoder_1/s_axis_image_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins v_frmbuf_rd_0/ap_rst_n]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports fan_en] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net zig_fifo_almost_empty [get_bd_pins jpeg_encoder_1/zig_fifo_almost_empty] [get_bd_pins system_ila_0/probe7]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets zig_fifo_almost_empty]
  connect_bd_net -net zig_fifo_almost_full [get_bd_pins jpeg_encoder_1/zig_fifo_almost_full] [get_bd_pins system_ila_0/probe5]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets zig_fifo_almost_full]
  connect_bd_net -net zig_fifo_empty [get_bd_pins jpeg_encoder_1/zig_fifo_empty] [get_bd_pins system_ila_0/probe6]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets zig_fifo_empty]
  connect_bd_net -net zig_fifo_full [get_bd_pins jpeg_encoder_1/zig_fifo_full] [get_bd_pins system_ila_0/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets zig_fifo_full]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins jpeg_encoder_1/m_axis_bin_aclk] [get_bd_pins jpeg_encoder_1/s_axis_image_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_frmbuf_rd_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI] -force
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
